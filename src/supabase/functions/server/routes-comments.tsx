...
console.log('📝 routes-comments.tsx module loaded');
...
comments.get('/admin/comments', async (c) => {
  try {
    console.log('💬 routes-comments.tsx: GET /admin/comments');
    ...
    console.log(`✅ Got ${authUsers.data?.users?.length || 0} auth users`);
...
comments.post('/admin/comments', async (c) => {
  try {
    console.log('💬 routes-comments.tsx: POST /admin/comments');
...
comments.put('/admin/comments/:id', async (c) => {
  try {
    console.log('💬 routes-comments.tsx: PUT /admin/comments/:id');
...
comments.delete('/admin/comments/:id', async (c) => {
  try {
    console.log('💬 routes-comments.tsx: DELETE /admin/comments/:id');
...
comments.get('/admin/comments/stats', async (c) => {
  try {
    console.log('💬 routes-comments.tsx: GET /admin/comments/stats');
